...
const updateSale = async (data: ExpenseFormData) => {
...
export function EditSaleForm({
  ...
  const [categories, setCategory] = useState<ExpenseCategory[]>([]);
  ...
  async function onSubmit(data: ExpenseFormData) {
    ...
    if (res.ok) {
      ...
      router.refresh();
      toast({
        title: "SUCCESS: Expense has been recorded",
      ...
      setLoading(false);
      toast({
        title: "FAILED: Expense has not been recorded",
